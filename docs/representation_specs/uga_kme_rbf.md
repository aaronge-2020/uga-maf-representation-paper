...
- Production UGA event or channel coordinates.
...
1. Build production UGA coordinates for mutation channels.
2. Select landmark coordinates from the production channel/event set.
...
- Preserved: patient-level mutation mass distribution over the production UGA coordinate system.
